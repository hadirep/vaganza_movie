...
const Color locationColor = Color(0xfff4f4f4);
const Color buttonColor = Color(0xff2e3a4f);
...
final TextTheme myTextTheme = TextTheme(
  ...
  titleLarge: GoogleFonts.roboto(fontSize: 18, fontWeight: FontWeight.w500, letterSpacing: 0.15),
