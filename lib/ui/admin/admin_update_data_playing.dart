...
Future<void> updatePlaying(context, [DocumentSnapshot? documentSnapshot]) async {
  if (documentSnapshot != null) {
    ...
    _movieRatingController.text = documentSnapshot['movieRating'];
                ...
                children: [
                  ...
                  Center(
                    ...
                    onPressed: () async {
                      ...
                      await _play.doc(documentSnapshot.id).update({
                        "name": name,
                        "genre": genre,
                        "duration": duration,
                        "director": director,
